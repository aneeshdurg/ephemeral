...
var JsStoreWorker = (function (e) {
            ...
            c = (function () {
                ...
                return (
                    (e.callDbDroppedByBrowser = function (t) {
                        e.dbStatus.conStatus === r.b.Connected &&
                    ...
                    (e.createTransaction = function (t, n, o) {
                        if (null === e.transaction) {
                            (o = o || r.e.ReadWrite),
                                (e.transaction = e.dbConnection.transaction(
                                    t,
                                    o
                                ));
                            var i = function () {
                            ...
                            (e.transaction.oncomplete = i),
                                (e.transaction.onabort = i);
                        }
                    }),
                    ...
                    (e.updateDbStatus = function (t, n) {
                        void 0 === n
                            ...
                            : (e.dbStatus = { conStatus: t, lastError: n });
                    }),
                    ...
                    (e.transaction = null),
                    (e.activeDbVersion = 0),
                    (e.dbStatus = { conStatus: r.b.NotStarted }),
                    e
                );
            })();
    },
            ...
            c = (function () {
                ...
                return (
                    (e.prototype.check = function (e) {
                        if (((this.status = !0), !0 === this.checkFlag))
                            for (var t in this.where) {
                    ...
                    (e.prototype.checkIn = function (e, t) {
                        for (
                            var n = 0, r = this.where[e][i.g.In], o = r.length;
                            n < o;
                            n++
                        ) {
                            if (r[n] === t) {
                    ...
                    (e.prototype.checkLike = function (e, t) {
                        ...
                        switch (
                            (u[1]
                                ? ((r = u[1]),
                                  (n = u.length > 2 ? i.f.Any : i.f.Last))
                                : ((r = u[0]), (n = i.f.First)),
                            (t = t.toLowerCase()),
                            n)
                        ) {
                            case i.f.Any:
                                (o = t.indexOf(r.toLowerCase())) < 0 &&
                                    (this.status = !1);
                                break;
                            case i.f.First:
                                ((o = t.indexOf(r.toLowerCase())) > 0 ||
                                ...
                                break;
                            default:
                                (o = t.lastIndexOf(r.toLowerCase())) <
                                    t.length - r.length && (this.status = !1);
                        }
                    }),
            ...
            l = (function (e) {
                ...
                return (
                    ...
                    (t.prototype.onErrorOccured = function (e, t) {
                        if ((void 0 === t && (t = !1), t))
                            e.logError(), (this.error = e.get());
                        else {
                            var n = void 0;
                            e.name
                                ? ((n = new s.a(e.name)).message = e.message)
                                : ((n = new s.a(e.target.error.name)).message =
                    ...
                    (t.prototype.goToWhereLogic = function () {
                        ...
                        if (this.objectStore.indexNames.contains(e)) {
                            ...
                            if ("object" == typeof t) {
                                ...
                                this.whereCheckerInstance = new c(
                                    this.query.where,
                                    n
                                );
                                var r = Object(a.a)(t);
                                switch (r) {
                                    case i.g.Like:
                                        var o = this.getRegexFromLikeExpression_(
                                            t[i.g.Like]
                                        );
                            ...
                            var u =
                                null == this.getColumnInfo(e, this.tableName)
                                    ? new s.a(i.d.ColumnNotExist, { column: e })
                ...
                return (
                    (e.prototype.checkAndModifyValue = function (e) {
                        ...
                        return (
                            ...
                            this.table.columns.every(function (e) {
                                return (
                                    t.checkAndModifyColumnValue_(e),
                                    !t.errorOccured
                                );
                            }),
                            this.errorOccured
                    ...
                    (e.prototype.checkNotNullAndDataType_ = function (e) {
                        e.notNull && u(this.value[e.name])
                            ? this.onValidationError_(r.d.NullValue, {
                                  ColumnName: e.name,
                              })
                            : e.dataType &&
                              !u(this.value[e.name]) &&
                              Object(c.a)(this.value[e.name]) !== e.dataType &&
                              this.onValidationError_(r.d.WrongDataType, {
                                  column: e.name,
                              });
                    }),
                    (e.prototype.checkAndModifyColumnValue_ = function (e) {
                        ...
                        e.autoIncrement
                            ? u(t)
                                ? (this.value[e.name] = ++this
                                      .autoIncrementValue[e.name])
                                : Object(c.a)(t) === r.c.Number &&
                                  t > this.autoIncrementValue[e.name] &&
                                  (this.autoIncrementValue[e.name] = t)
                            : e.default &&
                              u(t) &&
                ...
                return (
                    (e.prototype.checkAndModifyValues = function () {
                        ...
                        return Object(h.a)(function (t, n) {
                            var r = function (r) {
                                (e.valueCheckerObj = new a(e.table, r)),
                                    e.startChecking().then(t).catch(n);
                            };
                            !1 === f.a.isTransactionQuery
                                ? Object(l.a)(e.table)
                                      .then(function (e) {
                                          r(e);
                                      })
                                      .catch(n)
                                : r(_.autoIncrementValues[e.table.name]);
                        });
                    }),
                    (e.prototype.startChecking = function () {
                        ...
                        return Object(h.a)(function (t, n) {
                            ...
                            (e.values.every(function (t) {
                                return !(r = e.valueCheckerObj.checkAndModifyValue(
                                    t
                                ));
                            }),
                            ...
                            var o = Object(l.b)(
                                e.table,
                                e.valueCheckerObj.autoIncrementValue
                            );
                            !1 === f.a.isTransactionQuery
                                ? o.then(t).catch(n)
                                : t();
            ...
            _ = (function () {
                ...
                return (
                    ...
                    (e.prototype.isInsertQryValid_ = function (e) {
                        ...
                        if (n)
                            switch (Object(c.a)(this.query.values)) {
                                case r.c.Array:
                                    break;
                                case r.c.Null:
                    ...
                    (e.prototype.checkForNullInWhere_ = function () {
                        for (var e in this.query.where)
                            if (null == this.query.where[e])
                                return void (this.error = new i.a(
                                    r.d.NullValueInWhere,
                                    { column: e }
                                ).get());
                    }),
                    (e.prototype.checkFetchQuery_ = function () {
                        !0 === this.isTableExist_(this.query.from)
                            ? null != this.query.where &&
                              ...
                              null == this.error &&
                                  this.addGreatAndLessToNotOp_())
                            : (this.error = new i.a(r.d.TableNotExist, {
                                    ...
                                    t.forEach(function (t) {
                                        null != (n = e[t])[r.g.NotEqualTo] &&
                                            ...
                                            void 0 === e[r.g.Or]
                                                ...
                                                : void 0 === e[r.g.Or][t] &&
                                                  (e[r.g.Or][t] = {}),
                                            (e[r.g.Or][t][r.g.LessThan] =
                                                n[r.g.NotEqualTo]),
                                            delete e[t][r.g.NotEqualTo]);
                                    }),
                                    e
                                );
                            };
        ...
        var o,
            ...
            u = (function () {
                ...
                return (
                    (e.callDbDroppedByBrowser = function () {
                        e.isDbDeletedByBrowser =
                            e.dbStatus.conStatus === r.Connected;
                    }),
                    ...
                    (e.transaction = null),
                    (e.dbStatus = { conStatus: r.NotStarted }),
                    e
                );
            })(),
            c =
                ...
                return (
                    ...
                    (t.prototype.execute = function () {
                        ...
                        this.errorOccured ||
                            ...
                            (r.onsuccess = function (t) {
                                ...
                                n &&
                                    (n.delete(), ++e.rowAffected, n.continue());
                            }));
                    }),
                    (t.prototype.initTransaction = function () {
                        u.createTransaction(
                            ...
                            (this.objectStore = u.transaction.objectStore(
                                v.tableName
                            ));
                    }),
                ...
                return (
                    ...
                    (t.prototype.execute = function () {
                        var e,
                            t = this,
                            n = function () {
                                t.objectStore.add(t.query).onerror = function (
                                    e
                                ) {
                        ...
                        this.initTransaction(),
                            ((e = t.objectStore
                                .index(v.columnName)
                                .openCursor(
                                    IDBKeyRange.only(t.query[v.columnName])
            ...
            l = (function () {
                ...
                return (
                    (e.updateDbStatus = function (e, t) {
                        void 0 === t
                            ? (u.dbStatus.conStatus = e)
                            : (u.dbStatus = { conStatus: e, lastError: t });
                    }),
                    e
                );
            })(),
            ...
            p = function (e, t, n) {
                ...
                (u.isDbDeletedByBrowser = !1),
                    ...
                    (o.onsuccess = function (e) {
                        (u.dbStatus.conStatus = r.Connected),
                            (u.dbConnection = o.result),
                            (u.dbConnection.onclose = function () {
                                u.callDbDroppedByBrowser(),
                                    l.updateDbStatus(
                                        r.Closed,
                                        f.d.ConnectionClosed
                                    );
                            }),
                    ...
                    (o.onupgradeneeded = function (e) {
                        e.target.result
                            .createObjectStore(v.tableName, { keyPath: "Key" })
                        ...
                        if ("init_db" === e.name) this.executeLogic(e);
                            ...
                            switch (u.dbStatus.conStatus) {
                                ...
                                case r.NotStarted:
                                    ...
                                    break;
                                case r.Closed:
                                    u.isDbDeletedByBrowser &&
                                        this.createDb(
                                            function () {
                                                (u.isDbDeletedByBrowser = !1),
                                                    t.checkConnectionAndExecuteLogic(
                                                        e
                                                    );
                                            },
                                            function (e) {
                ...
                return (
                    ...
                    (e.executeCode = function () {
                        if (
                            ...
                            ).checkConnectionAndExecuteLogic(e);
                        }
                    }),
            ...
            m = (function () {
                ...
                return (
                    ...
                    (e.get = function (e) {
                        return v.prcoessQuery({ name: "get", query: e });
                    }),
                    (e.set = function (e, t) {
                        var n = { Key: e, Value: t };
                        return v.prcoessQuery({ name: "set", query: n });
                    }),
                    (e.remove = function (e) {
                        return v.prcoessQuery({ name: "remove", query: e });
                    }),
                    e
                );
            })();
    ...
    function (e, t, n) {
        ...
        var r,
                ...
                return (
                    ...
                    (t.prototype.execute = function (e) {
                        ...
                        (r.onerror = function (e) {
                            ...
                            (r.onsuccess = function (e) {
                                (t.dbStatus.conStatus = l.b.Connected),
                                    (t.dbConnection = r.result),
                                    (t.dbConnection.onclose = t.onDbClose.bind(
                                        t
                                    )),
                                    (t.dbConnection.onversionchange = t.onDbVersionChange.bind(
                                        t
                                    )),
                                    (t.dbConnection.onerror = t.onDbConError.bind(
                                        t
                                    )),
                                    o
                                        ? t
                                ...
                                e.forEach(function (e, t) {
                                    e.requireDelete
                                        ? (i.objectStoreNames.contains(
                                              e.name
                                          ) && i.deleteObjectStore(e.name),
                                          c(e, t))
                                        : e.requireCreation && c(e, t);
                                });
                            });
                    }),
                    (t.prototype.savedbNameIntoDbList_ = function () {
                        ...
                        return Object(p.a)(function (t, n) {
                            e.getDbList()
                                .then(function (r) {
                                    r.indexOf(e.dbName) < 0
                                        ? (r.push(e.dbName),
                                          e.setDbList(r).then(t).catch(n))
                                        : t();
                                })
                                .catch(n);
                        });
                        ...
                        this.activeDb.tables.forEach(function (t, n) {
                            t.columns.every(function (t) {
                                return (
                                    (e.activeDb.tables[
                                        n
                                    ].primaryKey = t.primaryKey ? t.name : ""),
                                    !t.primaryKey
                                );
                            });
                        });
                ...
                return (
                    ...
                    (e.prototype.setPrimaryKey_ = function () {
                        ...
                        this.columns.every(function (t) {
                            return (
                                (e.primaryKey = t.primaryKey ? t.name : ""),
                                !t.primaryKey
                            );
                        });
                    }),
                    (e.prototype.setRequireDelete_ = function (e) {
                        var t = this;
                        u.a
                            .get("JsStore_" + e + "_" + this.name + "_Version")
                            .then(function (e) {
                                null == e
                                    ? (t.requireCreation = !0)
                    ...
                    (e.prototype.setDbVersion_ = function (e) {
                        var t = this;
                        (a.a.activeDbVersion =
                            a.a.activeDbVersion > this.version
                                ? a.a.activeDbVersion
                                : this.version),
                            u.a.set(
                                "JsStore_" + e + "_Db_Version",
                                a.a.activeDbVersion
                            ),
                            u.a
                                .set(
            ...
            S = function (e) {
                (this.name = e.name),
                    (this.autoIncrement =
                        null != e.autoIncrement && e.autoIncrement),
                    ...
                    (this.enableSearch =
                        null == e.enableSearch || e.enableSearch),
                    (this.keyPath = e.keyPath);
            },
            C = function (e) {
                for (var t in ((this.columns = []),
                (this.name = e.name),
            ...
            N = (function () {
                ...
                return (
                    (e.prototype.checkConnectionAndExecuteLogic = function (e) {
                        var t = this;
                        switch (
                            (E.a.log("request executing:" + e.name), e.name)
                        ) {
                            case l.a.InitDb:
                            case l.a.IsDbExist:
                    ...
                    (e.prototype.executeLogic_ = function (t) {
                        ...
                        switch (
                            ((e.isTransactionQuery =
                                t.name === l.a.Transaction),
                            t.name)
                        ) {
                            case l.a.InitDb:
                                !0 === this.isDbDeletedByBrowser_
                                    ? this.initDb_(
                                          null,
                                          function () {
                                              (n.isDbDeletedByBrowser_ = !1),
                                                  r();
                                          },
                                          o
                                      )
                                    : this.initDb_(t.query, r, o);
                                break;
                            case l.a.OpenDb:
                    ...
                    (e.prototype.closeDb_ = function () {
                        a.a.dbStatus.conStatus === l.b.Connected &&
                            ((a.a.dbStatus.conStatus = l.b.ClosedByJsStore),
                            a.a.dbConnection.close());
                    }),
                        ...
                        null == e
                            ...
                            : (this.closeDb_(),
                              this.getDbVersion_(e.name)
                                  .then(function (o) {
                                      (r.activeDbVersion_ = o || 1),
                                          r
                                              .processCreateDb(new q(e))
                                              .then(t)
                                              .catch(n);
                                  })
                                  .catch(n));
    ...
    function (e, t, n) {
        ...
        var r,
            ...
            u = (function (e) {
                ...
                return (
                    i(t, e), (t.prototype.onQueryFinished = function () {}), t
                );
            })(o.a);
    },
    function (e, t, n) {
                ...
                return (
                    ...
                    (e.prototype.onDbClose = function (e) {
                        this.onDbDroppedByBrowser(),
                            this.updateDbStatus(
                                o.b.Closed,
                                o.d.ConnectionClosed
                            );
                    }),
                    (e.prototype.onDbVersionChange = function (e) {
                        null === e.newVersion &&
                            (e.target.close(),
                            this.onDbDroppedByBrowser(!0),
                            this.updateDbStatus(
                                o.b.Closed,
                                o.d.ConnectionClosed
                            ));
                ...
                return (
                    ...
                    (e.prototype.evaluate = function () {
                        for (var e = 0; e < this.length_; e++)
                            if (
                                !0 === this.checkCase_(this.caseColumnQuery_[e])
                            )
            ...
            O = (function (e) {
                function t() {
                    ...
                    return (
                        (t.sorted = !1),
                        (t.isSubQuery = !1),
                        (t.shouldEvaluateLimitAtEnd = !1),
                        (t.shouldEvaluateSkipAtEnd = !1),
                        (t.thenEvaluator = new m()),
                        t
                    );
                }
                return (
                    ...
                    (t.prototype.setPushResult = function () {
                        ...
                        this.query.case
                            ? (this.pushResult = function (t) {
                                  var n;
                                  for (n in (e.thenEvaluator.setCaseAndValue(
                                      e.query.case,
                                      t
                                  ),
                                  e.query.case))
                ...
                return (
                    ...
                    (t.prototype.executeWhereUndefinedLogic = function () {
                        ...
                        (o.onerror = this.onErrorOccured),
                            !1 === this.shouldEvaluateLimitAtEnd &&
                            !1 === this.shouldEvaluateSkipAtEnd
                        ...
                        o.onsuccess = function (r) {
                            (e = r.target.result)
                                ? n && t.results.length !== t.limitRecord
                                    ? (t.pushResult(e.value), e.continue())
                                    : ((n = !0), e.advance(t.skipRecord))
                                : t.onQueryFinished();
                        };
                    }),
                    ...
                    (t.prototype.executeLimitForIn_ = function (e, t) {
                        ...
                        Object(k.a)(
                            t.map(function (e) {
                                return (
                                    (t = e),
                                    Object(w.a)(function (e, u) {
                                        ((n = o.openCursor(
                                            r.getKeyRange(t)
                                        )).onsuccess = function (t) {
                                            (s = t.target.result) &&
                                            r.results.length !== r.limitRecord
                                                ? (i() && r.pushResult(s.value),
                                                  s.continue())
                                                : e();
                                        }),
                                            (n.onerror = u);
                ...
                return (
                    ...
                    (t.prototype.executeRegexLogic = function (e, t) {
                        ...
                        (l = this.skipRecord),
                            ...
                            (a = function () {
                                return (
                                    n.regexTest(f.key) &&
                                    n.whereCheckerInstance.check(f.value)
                                );
                            }),
                            ((p = this.objectStore
                                .index(e)
                                .openCursor()).onerror = this.onErrorOccured),
                            !1 === this.shouldEvaluateLimitAtEnd &&
                            !1 === this.shouldEvaluateSkipAtEnd
                                ? this.skipRecord && this.limitRecord
                    ...
                    (t.prototype.executeSkipAndLimitForRegex_ = function () {
                        ...
                        p.onsuccess = function (t) {
                            (f = t.target.result),
                                e.results.length !== e.limitRecord && f
                                    ? (a() && h(f.value), f.continue())
                                    : e.onQueryFinished();
                        };
                    }),
                    ...
                    (t.prototype.executeSimpleForRegex_ = function () {
                        ...
                        p.onsuccess = function (t) {
                            (f = t.target.result)
                                ? (a() && e.pushResult(f.value), f.continue())
                                : e.onQueryFinished();
                        };
                    }),
                    t
                ...
                return (
                    ...
                    (t.prototype.executeWhereLogic = function (e, t, n, r) {
                        ...
                        (_ = function () {
                            ...
                            ((d = this.objectStore
                                .index(e)
                                .openCursor(
                                    this.getKeyRange(t, n),
                                    r
                                )).onerror = this.onErrorOccured),
                            !1 === this.shouldEvaluateLimitAtEnd &&
                            !1 === this.shouldEvaluateSkipAtEnd
                                ? this.skipRecord && this.limitRecord
                        ...
                        d.onsuccess = function (n) {
                            (y = n.target.result)
                                ? t && e.results.length !== e.limitRecord
                                    ? (_() && e.pushResult(y.value),
                                      y.continue())
                                    : ((t = !0), y.advance(e.skipRecord))
                                : e.onQueryFinished();
                        };
                    }),
                    ...
                    (t.prototype.executeLimitForWhere_ = function () {
                        ...
                        d.onsuccess = function (t) {
                            (y = t.target.result) &&
                            e.results.length !== e.limitRecord
                                ? (_() && e.pushResult(y.value), y.continue())
                                : e.onQueryFinished();
                        };
                    }),
                ...
                return (
                    ...
                    (t.prototype.processGroupBy = function () {
                        ...
                        if (
                            ...
                            Object(A.a)(e) !== v.c.Object)
                        )
                            if (Object(A.a)(e) === v.c.String)
                            ...
                            var u = Object(P.a)(e);
                            for (var r in (this.thenEvaluator.setCaseAndColumn(
                                e,
                                u
                            ),
                            t))
                                n[
                                    this.thenEvaluator.setValue(t[r]).evaluate()
                                ] = t[r];
                        } else {
                            o = void 0;
                            for (var r in t) {
                                for (var i in ((o = ""),
                                this.thenEvaluator.setCaseAndValue(e, t[r]),
                                e))
                    ...
                    (t.prototype.executeAggregateGroupBy = function () {
                        ...
                        if (Object(A.a)(e) === v.c.String)
                            for (n in t) (r = t[n][e]), s(), (u[r] = t[n]);
                        else
                            for (n in t) {
                                for (var a in ((r = ""), e)) r += t[n][e[a]];
                                s(), (u[r] = t[n]);
                            }
                        for (var h in ((t = []), u)) t.push(u[h]);
                        if (c.avg)
                            if (Object(A.a)(c.avg) === v.c.String)
                                for (n in t) {
                                    var l = t[n]["sum(" + c.avg + ")"],
                                        f = t[n]["count(" + c.avg + ")"];
                                    (t[n]["avg(" + c.avg + ")"] = l / f),
                                        c.count !== c.avg &&
                                            delete t[n]["count(" + c.avg + ")"],
                                        c.sum !== c.avg &&
                                            delete t[n]["sum(" + c.avg + ")"];
                                }
                            else {
                ...
                return (
                    ...
                    (t.prototype.processGroupDistinctAggr = function () {
                        if (this.query.distinct) {
                            ...
                            var r = this.getPrimaryKey(this.query.from),
                                o = e.indexOf(r);
                            e.splice(o, 1),
                                (this.query.groupBy = e.length > 0 ? e : null);
                        }
                        this.query.groupBy
                    ...
                    (t.prototype.getOrderColumnInfo_ = function (e) {
                        ...
                        if (null == this.query.join)
                            t = this.getColumnInfo(e, this.query.from);
                        else {
                    ...
                    (t.prototype.processOrderBy = function () {
                        ...
                        if (e && this.results.length > 0 && !this.sorted) {
                            var t = Object(A.a)(e);
                            if (t === v.c.Object) this.orderBy_(e);
                            else if (t === v.c.Array) {
                                this.orderBy_(e[0]);
                                for (
                                    var n = function (t, n) {
                                            if (null == r.error) {
                                                var o = e[t - 1].by,
                                                    i = e[t],
                                                    u = i.by,
                                                    c = r.getOrderColumnInfo_(
                                                        u
                                                    );
                                                if (null != c) {
                                                    (u = c.name),
                                                        (i.type = r.getOrderType_(
                                                            i.type
                                                        ));
                                                    var s = r.getValueComparer_(
                                                        c,
                                                        i
                                                    );
                                                    r.results.sort(function (
                                                        e,
                                                        t
                                                    ) {
                                                        return e[o] === t[o]
                ...
                return (
                    ...
                    (t.prototype.deleteMetaData = function () {
                        ...
                        return Object(s.a)(function (t, n) {
                            i.a.remove("JsStore_" + e.dbName + "_Db_Version"),
                    ...
                    (t.prototype.deleteDb = function () {
                        ...
                        setTimeout(function () {
                            ...
                            (t.onblocked = function () {
                                null != e.onError_ &&
                                    e.onError_(new u.a(o.d.DbBlocked).get());
                            }),
                                (t.onerror = function (t) {
                                    null != e.onError_ &&
                                        e.onError_(event.target.error);
                                }),
                                (t.onsuccess = function () {
                                    e.deleteMetaData()
                                        .then(function () {
                                            e.onSuccess_(),
                                                (e.dbStatus.conStatus =
                                                    o.b.Closed);
                                        })
                                        .catch(e.onError_);
                                });
                ...
                return Object(c.a)(
                    n.map(function (n) {
                        var u =
                            ...
                            c = t[n];
                        return (
                            !0 === s.a.isTransactionQuery &&
                                (o.a.autoIncrementValues[e.name][n] = c),
                            i.a.set(u, c)
                        );
                    })
                );
                ...
                return (
                    ...
                    (t.prototype.execute = function () {
                        ...
                        t.checkAndModify()
                            .then(function () {
                                (e.query = t.query),
                                    e.insertData_(e.query.values);
                            })
                            .catch(this.onError);
                    }),
                    (t.prototype.onQueryFinished_ = function () {
                        !0 === this.isTransaction &&
                            this.onTransactionCompleted_();
                    }),
        ...
        var r,
                    ...
                    (t.prototype.executeWhereUndefinedLogic = function () {
                        ...
                        this.objectStore.count
                            ? ((e = this.objectStore.count()).onsuccess = function () {
                                  (n.resultCount = e.result),
                                      n.onQueryFinished();
                              })
                            : ((e = this.objectStore.openCursor()).onsuccess = function (
                                  e
                              ) {
                                  (t = e.target.result)
                ...
                return (
                    ...
                    (t.prototype.executeRegexLogic = function (e, t) {
                        ...
                        (o.onsuccess = function (e) {
                            (n = e.target.result)
                                ? (r.regexTest(n.key) &&
                                      r.whereCheckerInstance.check(n.value) &&
                                      ++r.resultCount,
                                  n.continue())
                                : r.onQueryFinished();
                        }),
                ...
                return (
                    ...
                    (t.prototype.executeWhereLogic = function (e, t, n) {
                        var r,
                            ...
                            i = this;
                        (t = n ? t[n] : t),
                            (1 === Object.keys(this.query.where).length &&
                                this.objectStore.count
                                ? function () {
                                      (r = i.objectStore
                                          .index(e)
            ...
            E = (function (e) {
                ...
                return (
                    ...
                    (t.prototype.execute = function () {
                        var e = this,
                            t = new m.a(b.a.Count, this.query);
                            ...
                            try {
                                var n = function () {
                                    new v.a(
                                        e.query,
                                        function (t) {
                                            (e.resultCount = t.length),
                                                e.onTransactionCompleted_();
                                        },
                                        e.onError
                                    ).execute();
                                };
        ...
        var r,
                    ...
                    (t.prototype.executeWhereLogic = function (e, t, n) {
                        ...
                        (t = n ? t[n] : t),
                            ((o = this.objectStore
                                ...
                                (r = e.target.result)
                                    ? (i.whereCheckerInstance.check(r.value) &&
                                          (r.delete(), ++i.rowAffected),
                                      r.continue())
                                    : i.onQueryFinished();
                            }),
                            (o.onerror = this.onErrorOccured.bind(this));
            ...
            D = (function (e) {
                ...
                return (
                    E(t, e),
                    (t.prototype.execute = function () {
                        var e = new m.a(b.a.Remove, this.query);
                                ...
                                function (t) {
                                    ...
                                    var u =
                                        (((n = {})[i] =
                                            (((r = {})[b.g.In] = o), r)),
                                        n);
                                    (e.query[b.g.Where] = u), e.processWhere_();
                                },
                                this.onError
                            );
    ...
    function (e, t, n) {
        ...
        var r,
            ...
            s = function (e, t) {
                for (var n in e)
                    if (Object(i.a)(e[n]) !== u.c.Object) t[n] = e[n];
                    else
                        for (var r in e[n]) {
                            switch (r) {
                                case "+":
                        ...
                        (o.onsuccess = function (e) {
                            if ((n = e.target.result))
                                if (
                                    ...
                                    try {
                                        var t = n.update(
                                            s(r.query.set, n.value)
                                        );
                                        (t.onsuccess = function () {
                                            ++r.rowAffected, n.continue();
                                        }),
                                            (t.onerror = r.onErrorOccured.bind(
                                                r
                                            ));
                                    } catch (e) {
                                        r.transaction.abort(),
                            ...
                            ((o = this.objectStore
                                ...
                                if ((r = e.target.result))
                                    if (i.whereCheckerInstance.check(r.value))
                                        try {
                                            var t = r.update(
                                                s(i.query.set, r.value)
                                            );
                                            (t.onsuccess = function () {
                                                ++i.rowAffected, r.continue();
                                            }),
                                                (t.onerror = i.onErrorOccured.bind(
                                                    i
                                                ));
                                        } catch (e) {
                                            i.transaction.abort(),
    ...
    function (e, t, n) {
        ...
        var r,
            ...
            l = (function (e) {
                ...
                return (
                    ...
                    (t.prototype.executeJoinQuery = function () {
                        var e = this,
                            t = this.query;
                        Object(c.a)(t.join) === o.c.Object
                            ? (this.joinQueryStack_ = [t.join])
                            : (this.joinQueryStack_ = t.join);
                        var n = t.from;
                        new b(
                            { from: n, where: t.where, case: t.case },
                            function (t) {
                    ...
                    (t.prototype.onJoinQueryFinished_ = function () {
                        ...
                        if (null == this.error) {
                            if (this.results.length > 0) {
                                ...
                                this.query[o.g.Skip] && this.query[o.g.Limit]
                                    ? (this.results.splice(
                                          0,
                                          this.query[o.g.Skip]
                                      ),
                    ...
                    (t.prototype.checkJoinQuery_ = function (e, t) {
                        ...
                        t.with !== i.table &&
                            ...
                            null == t.as && (t.as = {}),
                            c.columns.every(function (e) {
                                var c = s.columns.find(function (t) {
                                    return (
                                        t.name === e.name && t.name !== r.column
                                    );
                                });
                                return (
                                    null == c ||
            ...
            d = function () {
                ...
                for (t = 0; t < n; t++)
                    for (
                        var i = arguments[t], u = 0, c = i.length;
                        u < c;
                        u++, o++
                    )
                        r[o] = i[u];
            ...
            b = (function (e) {
                function t(t, n, r) {
                    ...
                    return (
                                ...
                                ? (o.processOrderBy(),
                                  o.error
                                      ...
                                      : (o.processGroupDistinctAggr(),
                                        o.shouldEvaluateSkipAtEnd &&
                                            o.results.splice(0, o.query.skip),
                                        o.shouldEvaluateLimitAtEnd &&
                                            (o.results = o.results.slice(
                                                0,
                                                o.query.limit
                                            )),
                        ...
                        (o.tableName = t.from),
                        o.setPushResult(),
                        Object(p.a)(o.query.where)
                            ? ((o.isArrayQry = !0),
                              (o.shouldEvaluateLimitAtEnd = !0),
                              (o.shouldEvaluateSkipAtEnd = !0))
                            : ((o.skipRecord = t.skip),
                              (o.limitRecord = t.limit)),
                        t.order &&
                            ((Object(p.a)(t.order) ||
                                t.order.case ||
                                "object" == typeof t.order.by) &&
                                (o.query.order.idbSorting = !1),
                            t.limit && (o.shouldEvaluateLimitAtEnd = !0),
                            t.skip && (o.shouldEvaluateSkipAtEnd = !0)),
                        t.groupBy &&
                            (t.limit && (o.shouldEvaluateLimitAtEnd = !0),
                            t.skip && (o.shouldEvaluateSkipAtEnd = !0)),
                        o
                        ...
                        var t,
                            ...
                            s = function () {
                                (e.query.where = n.shift()),
                                    e.query.where[o.g.Or] &&
                                    1 === Object.keys(e.query.where).length
                                        ? ((t = o.g.Or),
                                          (e.query.where =
                                              e.query.where[o.g.Or]),
                                          (e.onWhereArrayQrySuccess = c))
                                        : ((t = o.g.And),
                                          (e.onWhereArrayQrySuccess = c)),
                                    e.processWhere_();
                            };
    ...
    function (module, __webpack_exports__, __webpack_require__) {
        ...
        var _common_index__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(0),
            ...
            _select_index__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
                30
            ),
            _count_index__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(27),
            _insert_index__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
                26
            ),
            _remove_index__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
                28
            ),
            _update_index__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
                29
            ),
            ...
            _helpers_index__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
                15
            ),
            _helpers_index__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
                25
            ),
            _helpers_index__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
                14
            ),
            ...
            Instance = (function (_super) {
                ...
                return (
                    ...
                    (Instance.prototype.execute = function () {
                        ...
                        null == t
                            ? Object(
                                  _helpers_index__WEBPACK_IMPORTED_MODULE_9__.a
                              )(
                                  this.query.tables.map(function (t) {
                                      return Object(
                                          _helpers_index__WEBPACK_IMPORTED_MODULE_10__.a
                                      )(e.getTable(t));
                                  })
                              )
                                  .then(function (t) {
                                      t.forEach(function (t, n) {
                                          _query_helper__WEBPACK_IMPORTED_MODULE_7__.a.autoIncrementValues[
                                              e.query.tables[n]
                                          ] = t;
                                      }),
                                          e.startExecution_();
                                  ...
                                  .catch(this.onError)
                            : this.onError(
                                  new _log_helper__WEBPACK_IMPORTED_MODULE_8__.a(
                                      _common_index__WEBPACK_IMPORTED_MODULE_0__.d.TableNotExist,
                                      { tableName: t }
                                  ).get()
                              );
                    }),
                    (Instance.prototype.startExecution_ = function () {
                        var _this = this,
                            ...
                            txLogic = null;
                        !0 ===
                        _config__WEBPACK_IMPORTED_MODULE_12__.a.isRuningInWorker
                    ...
                    (Instance.prototype.executeRequest_ = function (e) {
                        ...
                        switch (((this.isQueryExecuting = !0), e.name)) {
                            case _common_index__WEBPACK_IMPORTED_MODULE_0__.a
                                .Select:
                                t = new _select_index__WEBPACK_IMPORTED_MODULE_2__.a(
                                    e.query,
                            ...
                            case _common_index__WEBPACK_IMPORTED_MODULE_0__.a
                                .Insert:
                                t = new _insert_index__WEBPACK_IMPORTED_MODULE_4__.a(
                                    e.query,
                                    this.onRequestFinished_.bind(this),
                                    this.onError.bind(this)
                                );
                            ...
                            case _common_index__WEBPACK_IMPORTED_MODULE_0__.a
                                .Update:
                                t = new _update_index__WEBPACK_IMPORTED_MODULE_6__.a(
                                    e.query,
                                    this.onRequestFinished_.bind(this),
                                    this.onError.bind(this)
                                );
                            ...
                            case _common_index__WEBPACK_IMPORTED_MODULE_0__.a
                                .Remove:
                                t = new _remove_index__WEBPACK_IMPORTED_MODULE_5__.a(
                                    e.query,
                                    this.onRequestFinished_.bind(this),
                                    this.onError.bind(this)
                                );
                            ...
                            case _common_index__WEBPACK_IMPORTED_MODULE_0__.a
                                .Count:
                                t = new _count_index__WEBPACK_IMPORTED_MODULE_3__.a(
                                    e.query,
                                    this.onRequestFinished_.bind(this),
                                    this.onError.bind(this)
                                );
                    ...
                    (Instance.prototype.pushRequest_ = function (e) {
                        var t = this,
                            ...
                            r = Object(
                                _helpers_index__WEBPACK_IMPORTED_MODULE_11__.a
                            )(function (n, r) {
                                (e.onSuccess = function (e) {
                                    n(e);
                                }),
                    ...
                    (Instance.prototype.checkQueries_ = function (e) {
                        return Object(
                            ...
                            e.map(function (e) {
                                ...
                                return new _query_helper__WEBPACK_IMPORTED_MODULE_7__.a(
                                    e.name,
                                    e.query
                                ).checkAndModify();
                            })
